            ...
            <div class="card card-primary">
              ...
              <form role="form" action="<?php base_url('admin/sosmed/add') ?>" method="post" enctype="multipart/form-data" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>" id="nama" placeholder="Nama Sosmed" name="nama">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control <?php echo form_error('icon') ? 'is-invalid':'' ?>" id="icon" placeholder="icon" name="icon">
                    <div class="invalid-feedback">
